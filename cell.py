...
class ConvLSTMCell(tf.contrib.rnn.RNNCell):
  ...
  def __init__(self, shape, filters, kernel, initializer=None, forget_bias=1.0, activation=tf.tanh):
    self._kernel = kernel
...
class ConvGRUCell(tf.contrib.rnn.RNNCell):
  ...
  def __init__(self, shape, filters, kernel, initializer=None, activation=tf.tanh):
    self._filters = filters
    self._kernel = kernel
    self._initializer = initializer
    self._activation = activation
